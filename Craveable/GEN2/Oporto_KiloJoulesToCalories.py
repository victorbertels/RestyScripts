...
Oporto_products = pcli.products.list_all(q={"account" : "63435e96e54f9c12e91c9745" ,"location" : "634369db0874baccc405a53a", "productType": 1 ,"calories" : {"$exists" : True}})

for product in Oporto_products:
    PosValuesCalories = product.posValues.calories
    plu = product.plu
    etag = product._etag
    KiloJoules = product.calories
    if not PosValuesCalories:
       
    if PosValuesCalories == KiloJoules:
    ...
    # print(product.plu)
    # print("------------------------------------------")
    url = f"https://api.deliverect.com/v3/products/63435e96e54f9c12e91c9745/{plu}"
    payload = json.dumps({
